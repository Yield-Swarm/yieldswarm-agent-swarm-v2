# YieldSwarm Terraform Cloud bootstrap (PR #3 — modular optional addon)
# Enables Azure VMSS fallback targeting via HelixChainProd workspace.
# Usage: make tfc-init && make tfc-apply
# Does not replace deploy/terraform/ production orchestrator.
