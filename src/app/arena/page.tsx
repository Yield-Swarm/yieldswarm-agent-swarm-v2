...
export default function ArenaPage(): JSX.Element {
  ...
  // Narrow once: treasury (and its velocity) may be null until the first poll
  // resolves, so guard before formatting to avoid dereferencing null.
  const treasuryVelocity = state.treasury?.velocityUsdPerHour ?? null;
      ...
      <div className="mx-auto w-full max-w-7xl px-6 py-10">
        ...
        <section className="mb-6 grid gap-4 md:grid-cols-2 xl:grid-cols-5">
          ...
          <StatCard
            ...
            value={
              treasuryVelocity !== null
                ? `${treasuryVelocity >= 0 ? "+" : ""}${currencyFormatter.format(treasuryVelocity)}/hr`
                : "—"
            }
