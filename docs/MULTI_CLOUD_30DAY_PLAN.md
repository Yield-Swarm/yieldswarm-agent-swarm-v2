...
Aggressive free-credit utilization across Akash, Vast.io, RunPod, Salad, Cherry Servers, Polrunner/Hushki, Azure, Google Cloud, AWS, Alibaba, and HashiCorp Vault — with **Akash first** for real GPU revenue (Bittensor + inference).

> **Royal Decree sprint:** Start with the combined 7-day plan in `docs/ROYAL_DECREE_30DAY_SPRINT.md` before scaling to the full provider matrix below.
...
| **8** | **Salad** | Consumer GPU share | Week 2–3 overflow |
| **9** | **Cherry Servers** | Bare-metal GPU | Week 2–3 dedicated workloads |
| **10** | **Polrunner / Hushki** | Niche GPU promos | Week 3 filler |
